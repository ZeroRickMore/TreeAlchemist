...
def test():
    all_states, state_id_to_state = get_all_states_to_defense_from_states_to_defense_xml(r'Z:\GitHub\TreeAlchemizer\TreeAlchemist\Code\TreeAlchemizer\Input-Files\test-tree')
