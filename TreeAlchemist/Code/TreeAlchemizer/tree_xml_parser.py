...
def test():
    ...
    #adt, _ = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'TreeAlchemizer', 'Input-Files', 'Test', 'test-tree-functional.xml'))
    #generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'TreeAlchemizer', 'Input-Files', 'Test', 'test-tree-wrong-alr-exist-id.xml'))
    #generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'TreeAlchemizer', 'Input-Files', 'Test', 'test-tree-wrong-alr-exist-id.xml'))
    #adt = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'TreeAlchemizer', 'Input-Files', 'Test', 'test-tree-wrong-rule-id.xml'))
    adt, _  = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'TreeAlchemizer', 'Input-Files', 'Test', 'test-tree-multinode-functional.xml'))
    #generate_ADT_from_xml_file(os.path.join(path_append, r"TreeAlchemist\Code\TreeAlchemizer\Input-Files\Test\test-tree-mismatched-root-path.xml"))
    #generate_ADT_from_xml_file(os.path.join(path_append, r"TreeAlchemist\Code\TreeAlchemizer\Input-Files\Test\test-tree-too-many-roots.xml"))
    #generate_ADT_from_xml_file(os.path.join(path_append, r"TreeAlchemist\Code\TreeAlchemizer\Input-Files\Test\test-tree-duplicate-name.xml"))
    #generate_ADT_from_xml_file(os.path.join(path_append, r"TreeAlchemist\Code\TreeAlchemizer\Input-Files\Test\test-tree-duplicate-id.xml"))
    #adt = generate_ADT_from_xml_file(os.path.join(path_append, r"TreeAlchemist\Code\TreeAlchemizer\Input-Files\Test\test-tree-invalid-path.xml"))
