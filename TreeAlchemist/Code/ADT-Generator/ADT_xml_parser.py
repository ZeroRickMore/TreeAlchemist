...
def test():
    ...
    #adt, _ = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'ADT-Generator', 'Input-Files', 'Test', 'test-tree-functional.xml'))
    #generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'ADT-Generator', 'Input-Files', 'Test', 'test-tree-wrong-alr-exist-id.xml'))
    #generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'ADT-Generator', 'Input-Files', 'Test', 'test-tree-wrong-alr-exist-id.xml'))
    #adt = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'ADT-Generator', 'Input-Files', 'Test', 'test-tree-wrong-rule-id.xml'))
    adt, _  = generate_ADT_from_xml_file(os.path.join(path_append, 'TreeAlchemist', 'Code', 'ADT-Generator', 'Input-Files', 'Test', 'test-tree-multinode-functional.xml'))
